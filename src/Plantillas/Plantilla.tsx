...
export default function Plantilla({name ,setName,de,para}:campos){
    ...
    return(
        ...
        <Document>
            <Page>
            <div className="container box py-5 px-5"  style={{
                        padding:'10px'
                    }}>
                    <Text style={{ textAlign: "center" }}>MEMORANDUM</Text>
                    <div>
                    <ul style={{
                        fontSize:'11px',
                        lineHeight:'2px'
                        ...
                        <li>
                            <Text>DE:{de?de:" ______"}</Text>
                        </li>
                        <li>
                            <Text>PARA:{para?para:" ______"}</Text>
                        </li>
                        <li>
                            <Text>FECHA:</Text>
                        </li>
                        <li>
                            <Text style={{
                                        fontSize:'9px'
                                    }}>Asunto:Sancion disciplinaria por incumplimiento del Reglamento Interno de Trabajo.</Text>
                        </li>
                    </ul>
                        <Text style={{
                            fontSize:'11px',
                        ...
                        Sr./Sra.{name?name:" ______"} , por medio de la 
                        ...
                        <div style={{ width: "90px" }}>
                            <hr />
                            <Text style={{ fontSize: "7px" }}>REPRESENTANTE LEGAL</Text>
                            <Text style={{ fontSize: "7px" }}>CINEPLEX S.A.</Text>
                        </div>
                        </div>
                    </div>
                </div>
